;; Temporary port, should be considered implementation detail
;; for now. Original path is src/main/clojure/clojure/data/priority_map.cljc.
...
"}
    flybot.ports.clojure.data.priority-map
